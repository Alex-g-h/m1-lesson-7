...
console.log('initial value: ', temperatureInCelsius, typeof temperatureInCelsius);
temperatureInCelsius = Number(temperatureInCelsius);
console.log('after conversion value: ', temperatureInCelsius, typeof temperatureInCelsius);
